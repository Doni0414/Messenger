...
public class RESTClient {
    public static void main(String[] args) throws JsonProcessingException {
        ...
        createSensor(restTemplate, "sensor24");
        populateRandomMeasurements(restTemplate, "sensor24");
    ...
    public static List<MeasurementDTO> printMeasurements(RestTemplate restTemplate){
